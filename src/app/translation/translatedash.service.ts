...
export class TranslatedashService {
  private translations: any = {
    en: {
      ...
      'producttable.arabicname': 'Name(Ar)',
      'producttable.arabicdes': 'Description(Ar)',
      'producttable.desc': 'Description',
      ...
      'Relatedtable.name': 'Name(En)',
      'Relatedtable.arabicname': 'Name(AR)',
      'Relatedtable.desc': 'Description(En)',
      'Relatedtable.arabicdesc': 'Description(Ar)',
      ...
      'Categorytable.arabicname': 'Name(Ar)',
      'Categorytable.arabicdes': 'Description(Ar)',
      'Categorytable.desc': 'Description',
      //messages
      ...
      formValid: ' Please Enter Valid data...',
    },
    ar: {
      ...
      'producttable.name': 'إسم المنتج بالإنجليزية',
      'producttable.arabicname': 'إسم المنتج بالعربية',
      'producttable.desc': 'الوصف بالإنجليزية',
      'producttable.arabicdesc': 'الوصف بالعربية',
      ...
      'Relatedtable.name': 'الاسم بالإنجليزية',
      'Relatedtable.arabicname': 'الاسم بالعربية',
      'Relatedtable.desc': 'الوصف بالإنجليزية',
      'Relatedtable.arabicdesc': 'الوصف بالعربية',
      ...
      'Categorytable.arabicname': 'إسم الفئة بالعربية',
      'Categorytable.arabicdes': 'الوصف بالعربية',

      'Categorytable.desc': 'الوصف',
      ...
      formValid: 'من فضلك أدخل بيانات صحيحة...',
    },
  };
